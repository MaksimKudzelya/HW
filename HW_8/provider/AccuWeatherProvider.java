...
import HW_8.dto.WeatherResponse;
import HW_8.enums.Periods;
import HW_8.enums.entity.WeatherData;
import HW_8.repository.DatabaseRepository;
import HW_8.repository.DatabaseRepositorySQLiteImpl;
...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    public void getWeather(Periods periods) throws IOException, SQLException {
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            System.out.println("Seichas v gorode " + ApplicationGlobalState.getInstance().getSelectedCity() +
        ...
        if (periods.equals(Periods.FIVE_DAYS)) {
            ...
            for (WeatherResponse weather: weatherResponseList) {
                System.out.println("V gorode " + ApplicationGlobalState.getInstance().getSelectedCity() + " na sledyushyu daty " + weather.getDate().substring(0,10) +
                        " ojidaetsya takaya pogoda: Minimalnaya temperatyra "  + weather.getTemperature().getMinimum().getValue() + "°С. Maksimalnaya temperatyra " +
    ...
    public String detectCityKey() throws IOException {
        ...
        if (!response.isSuccessful()) {
            throw new IOException("Nevozmojno prochest informatiu o gorode. " +
